...
namespace Mitoop\LaravelSnowflake\Facades {
    ...
    class Snowflake {
        ...
        public static function id()
        {
            /** @var \Mitoop\Snowflake\Snowflake $instance */
            return $instance->id();
        }
        ...
        {
            /** @var \Mitoop\Snowflake\Snowflake $instance */
            return $instance->setDatacenterId($datacenterId);
        }
        ...
        {
            /** @var \Mitoop\Snowflake\Snowflake $instance */
            return $instance->setWorkerId($workerId);
        }

        /**
         * @static
         */
        public static function setSequenceStrategy($strategy)
        {
            /** @var \Mitoop\Snowflake\Snowflake $instance */
            return $instance->setSequenceStrategy($strategy);
        }

        /**
         * @static
         */
        public static function getSequenceStrategy()
        {
            /** @var \Mitoop\Snowflake\Snowflake $instance */
            return $instance->getSequenceStrategy();
        }
        ...
        {
            return \Mitoop\Snowflake\Snowflake::getMaxSequence();
        }
...
namespace Illuminate\Support {
    ...
    class Str {
         ...
         * @param $prefix
         * @return string
         * @see \Mitoop\LaravelSnowflake\ServiceProvider::register()
         * @static
         */
        public static function snowflakeId($prefix = '')
        {
            return \Illuminate\Support\Str::snowflakeId($prefix);
        }
...
namespace Illuminate\Database\Schema {
    ...
    class Blueprint {
        /**
         * @see \class@anonymous /Users/fengqiyue/web/admin9-labs/admin9-backend-laravel/vendor/mitoop/laravel-snowflake/src/ServiceProvider.php:47$74::snowflake()
         * @param string $column
         * @static
         */
...
namespace  {
    ...
    class Snowflake extends \Mitoop\LaravelSnowflake\Facades\Snowflake {}
