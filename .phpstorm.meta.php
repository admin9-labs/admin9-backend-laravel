...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/fengqiyue/web/comfyui-ai/Server/public/storage' => 'string',
...
'app.aliases.Vite','app.api_domain','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
'auth.guards.web.provider','auth.guards.admin.driver','auth.guards.admin.provider','auth.guards.user.driver','auth.guards.user.provider',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/fengqiyue/web/comfyui-ai/Server/public/storage','hashids.default','hashids.connections.main.salt',
...
'logging.channels.single.level','logging.channels.single.replace_placeholders','logging.channels.single.tap','logging.channels.daily.driver','logging.channels.daily.path',
'logging.channels.daily.level','logging.channels.daily.days','logging.channels.daily.replace_placeholders','logging.channels.daily.tap','logging.channels.slack.driver',
...
'logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.sql.driver','logging.channels.sql.path',
'logging.channels.sql.level','logging.channels.sql.permission','logging.channels.sql.tap','logging.query.enabled','logging.query.channel',
'logging.query.excluded_tables','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme','mail.mailers.smtp.url',
...
'broadcasting.connections.null.driver','view.paths','view.compiled','tinker.commands','tinker.alias',
'tinker.dont_alias',);
        registerArgumentsSet('middleware', 
'web','api',);
        registerArgumentsSet('routes', 'workflows.index',
'workflows.store','workflows.show','workflows.update','workflows.destroy','storage.local',);
...
'JWT_ALGO','API_DOMAIN','CLOUD_DOMAIN','COMFY_API_URL',);
