    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Mitoop\Http\Headers\HeaderResolverInterface' => \Mitoop\Http\Headers\NullHeaderResolver::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/fengqiyue/web/admin9-labs/admin9-backend-laravel/public/storage' => 'string',
            'hashids.default' => 'string',
            'hashids.connections.main.salt' => 'string',
            'hashids.connections.main.length' => 'integer',
            'hashids.connections.main.alphabet' => 'string',
            'hashids.connections.jwt.salt' => 'string',
            'hashids.connections.jwt.length' => 'integer',
            'hashids.connections.jwt.alphabet' => 'string',
            ...
            'logging.query.enabled' => 'boolean',
            'logging.query.channel' => 'string',
            'logging.query.excluded_tables' => 'array',
            'mail.default' => 'string',
            ...
            'snowflake.epoch' => 'string',
            'snowflake.datacenter_id' => 'integer',
            'snowflake.worker_id' => 'integer',
            'snowflake.sequence_strategy' => 'NULL',
            'snowflake.redis_connection' => 'string',
...
'auth.guards.admin.provider','auth.guards.user.driver','auth.guards.user.provider','auth.providers.users.driver','auth.providers.users.model',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/fengqiyue/web/admin9-labs/admin9-backend-laravel/public/storage','hashids.default','hashids.connections.main.salt',
'hashids.connections.main.length','hashids.connections.main.alphabet','hashids.connections.jwt.salt','hashids.connections.jwt.length','hashids.connections.jwt.alphabet',
...
'logging.channels.emergency.path','logging.channels.sql.driver','logging.channels.sql.path','logging.channels.sql.level','logging.channels.sql.permission',
'logging.channels.sql.tap','logging.query.enabled','logging.query.channel','logging.query.excluded_tables','mail.default',
...
'reverb.apps.apps.0.max_message_size','services.postmark.token','services.resend.key','services.ses.key','services.ses.secret',
...
'session.secure','session.http_only','session.same_site','session.partitioned','snowflake.epoch',
'snowflake.datacenter_id','snowflake.worker_id','snowflake.sequence_strategy','snowflake.redis_connection','telescope.enabled',
...
'web','api',);
        registerArgumentsSet('routes', 'telescope','admin.auth.login',
'admin.auth.refresh','admin.auth.logout','admin.account.show','admin.account.update','admin.account.password.update',
'auth.register','auth.login','auth.sms.login','auth.email.login','auth.oauth.redirect',
'auth.oauth.callback','auth.verification-code.store','auth.password.reset.store','auth.password.reset.update','auth.logout',
'auth.refresh','user.profile.show','user.profile.update','user.avatar.update','user.avatar.destroy',
'user.password.update','user.phone.update','user.phone.destroy','user.email.update','user.email.destroy','storage.local',);
...
'auth.authenticated','messages.not_implemented',);
...
'JWT_ALGO','TELESCOPE_ENABLED','REVERB_APP_ID','REVERB_APP_KEY','REVERB_APP_SECRET',
